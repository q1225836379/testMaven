...
<div class="button_bar">
	...
	<button class="common_button" onclick="to('toAdd.action');">新建</button>  
...
<!-- 使用form标签可以把table包裹起来，并且发送请求
 ...
 -->
<form action="../sale/list.action" id="salChance">
	...
	<c:forEach items="${pageInfo.lists}" var="saleChance" >
		<tr>
			...
			<td class="list_data_op">
				<img onclick="to('toDispatch.action?chcId=${saleChance.chcId}');" title="指派" src="../images/bt_linkman.gif" class="op_button" />
				<!-- 把to中的参数替换handler的地址  sale/toEdit.action -->
				<img onclick="to('toEdit.action?chcId=${saleChance.chcId}');" title="编辑" src="../images/bt_edit.gif" class="op_button" />
				<img onclick="del('delete.action?chcId=${saleChance.chcId}');" title="删除" src="../images/bt_del.gif" class="op_button" />
...
<form action="../sale/list.action" id="go">
<div class="pager">
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../sale/list.action?pageNum=1&chcCustName=${pageInfo.entity.chcCustName}&chcTitle=${pageInfo.entity.chcTitle}&chcLinkman=${pageInfo.entity.chcLinkman}&pageSize=${pageInfo.pageSize}">首页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../sale/list.action?pageNum=${pageInfo.pageNum-1}&chcCustName=${pageInfo.entity.chcCustName}&chcTitle=${pageInfo.entity.chcTitle}&chcLinkman=${pageInfo.entity.chcLinkman}&pageSize=${pageInfo.pageSize}">上一页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../sale/list.action?pageNum=${pageInfo.pageNum+1}&chcCustName=${pageInfo.entity.chcCustName}&chcTitle=${pageInfo.entity.chcTitle}&chcLinkman=${pageInfo.entity.chcLinkman}&pageSize=${pageInfo.pageSize}">下一页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../sale/list.action?pageNum=${pageInfo.totalPage}&chcCustName=${pageInfo.entity.chcCustName}&chcTitle=${pageInfo.entity.chcTitle}&chcLinkman=${pageInfo.entity.chcLinkman}&pageSize=${pageInfo.pageSize}">最后一页</a>
	      </c:otherwise> 
   </c:choose>
