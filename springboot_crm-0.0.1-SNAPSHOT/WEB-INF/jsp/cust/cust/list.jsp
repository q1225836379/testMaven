...
<div class="button_bar">
    ...
    <button class="common_button" onclick="to('../cust/toAdd.action');">新建</button>  
	<button class="common_button" onclick="save('customer')">查询</button>  
</div>
<form action="../cust/list.action" id="customer">
	...
	<tr>
		...
		<c:choose>
			<c:when test="${customer.custStatus==1}">
				<img onclick="to('../cust/toEdit.action?custNo=${customer.custNo}');" title="编辑" src="${pageContext.request.contextPath}/images/bt_edit.gif" class="op_button" />
				<img onclick="to('../linkman/list.action?custNo=${customer.custNo}&custName=${customer.custName}');" title="联系人" src="${pageContext.request.contextPath}/images/bt_linkman.gif" class="op_button" />
				<img onclick="to('../activity/list.action?custNo=${customer.custNo}&custName=${customer.custName}');" title="交往记录" src="${pageContext.request.contextPath}/images/bt_acti.gif" class="op_button" />
				<!-- 因为后台方法应该是Orders对象接收数据，odr_cust_no ，odr_customer -->
				<img onclick="to('../orders/list.action?odrCustNo=${customer.custNo}&odrCustomer=${customer.custName}');" title="历史订单" src="${pageContext.request.contextPath}/images/bt_orders.gif" class="op_button" />
				<img onclick="to('../cust/delete.action?custNo=${customer.custNo}');" title="删除" src="${pageContext.request.contextPath}/images/bt_del.gif" class="op_button" />
...
<form action="../cust/list.action" id="go">
<div class="pager">
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../cust/list.action?pageNum=1&custNo=${pageInfo.entity.custNo}&custName=${pageInfo.entity.custName}&custManagerName=${pageInfo.entity.custManagerName}&pageSize=${pageInfo.pageSize}&custRegion=${pageInfo.entity.custRegion}&custLevelLabel=${pageInfo.entity.custLevelLabel}">首页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../cust/list.action?pageNum=${pageInfo.pageNum-1}&custNo=${pageInfo.entity.custNo}&custName=${pageInfo.entity.custName}&custManagerName=${pageInfo.entity.custManagerName}&pageSize=${pageInfo.pageSize}&custRegion=${pageInfo.entity.custRegion}&custLevelLabel=${pageInfo.entity.custLevelLabel}">上一页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../cust/list.action?pageNum=${pageInfo.pageNum+1}&custNo=${pageInfo.entity.custNo}&custName=${pageInfo.entity.custName}&custManagerName=${pageInfo.entity.custManagerName}&pageSize=${pageInfo.pageSize}&custRegion=${pageInfo.entity.custRegion}&custLevelLabel=${pageInfo.entity.custLevelLabel}">下一页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../cust/list.action?pageNum=${pageInfo.totalPage}&custNo=${pageInfo.entity.custNo}&custName=${pageInfo.entity.custName}&custManagerName=${pageInfo.entity.custManagerName}&pageSize=${pageInfo.pageSize}&custRegion=${pageInfo.entity.custRegion}&custLevelLabel=${pageInfo.entity.custLevelLabel}">最后一页</a>
	      </c:otherwise> 
   </c:choose>
