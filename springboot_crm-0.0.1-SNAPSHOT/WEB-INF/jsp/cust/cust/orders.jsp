...
<table class="data_list_table">
	...
	<tr>
		...
		<td class="list_data_op">
			<img onclick="to('../orders/show.action?odrId=${order.odrId}');" title="查看明细" src="${pageContext.request.contextPath}/images/bt_detail.gif" class="op_button" /></td>
	</tr>
	</c:forEach>
		<tr>
		<th colspan="100" class="pager">
<form action="../orders/list.action" id="go">
<div class="pager">
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../orders/list.action?pageNum=1&odrCustNo=${pageInfo.entity.odrCustNo}&odrCustomer=${pageInfo.entity.odrCustomer}&pageSize=${pageInfo.pageSize}">首页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../orders/list.action?pageNum=${pageInfo.pageNum-1}&odrCustNo=${pageInfo.entity.odrCustNo}&odrCustomer=${pageInfo.entity.odrCustomer}&pageSize=${pageInfo.pageSize}">上一页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../orders/list.action?pageNum=${pageInfo.pageNum+1}&odrCustNo=${pageInfo.entity.odrCustNo}&odrCustomer=${pageInfo.entity.odrCustomer}&pageSize=${pageInfo.pageSize}">下一页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../orders/list.action?pageNum=${pageInfo.totalPage}&odrCustNo=${pageInfo.entity.odrCustNo}&odrCustomer=${pageInfo.entity.odrCustomer}&pageSize=${pageInfo.pageSize}">最后一页</a>
	     </c:otherwise> 
   </c:choose>
