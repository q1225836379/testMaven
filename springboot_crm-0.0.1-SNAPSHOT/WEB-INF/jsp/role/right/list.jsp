...
<form id="roleForm" action="../role/roleManage.action" method="post"> 
  ...
  <tr>
    ...
    <c:forEach items="${rightList}" var="right">
    	<c:if test="${right.rightType=='Folder'}">
	    	<DIV>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	       	${right.rightText}
	      	<img onclick="to('../role/toRightAdd.action?rightParentCode=${right.rightCode}&rightText=${right.rightText}');" title="添加子模块" src="/crm/images/plus.png" class="op_button"> </DIV>
    	</c:if>
    	<c:if test="${right.rightType=='Document'}">
	    	<DIV>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	       	${right.rightText}
	      	<img onclick="to('../role/toRightEdit.action?rightCode=${right.rightCode}');" title="编辑" src="/crm/images/bt_edit.gif" class="op_button">
	      	<img onclick="to('../role/rightDelete.action?rightCode=${right.rightCode}');" title="删除" src="/crm/images/bt_del.gif" class="op_button"> </DIV>
    	</c:if>
    </c:forEach>
