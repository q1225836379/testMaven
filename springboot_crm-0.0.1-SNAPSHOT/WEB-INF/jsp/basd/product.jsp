...
<form action="../product/list.action" id="product">
...
<form action="../product/list.action" id="go">
<div class="pager">
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../product/list.action?pageNum=1&prodName=${pageInfo.entity.prodName}&prodType=${pageInfo.entity.prodType}&prodBatch=${pageInfo.entity.prodBatch}&pageSize=${pageInfo.pageSize}">首页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../product/list.action?pageNum=${pageInfo.pageNum-1}&prodName=${pageInfo.entity.prodName}&prodType=${pageInfo.entity.prodType}&prodBatch=${pageInfo.entity.prodBatch}&pageSize=${pageInfo.pageSize}">上一页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../product/list.action?pageNum=${pageInfo.pageNum+1}&prodName=${pageInfo.entity.prodName}&prodType=${pageInfo.entity.prodType}&prodBatch=${pageInfo.entity.prodBatch}&pageSize=${pageInfo.pageSize}">下一页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../product/list.action?pageNum=${pageInfo.totalPage}&prodName=${pageInfo.entity.prodName}&prodType=${pageInfo.entity.prodType}&prodBatch=${pageInfo.entity.prodBatch}&pageSize=${pageInfo.pageSize}">最后一页</a>
	      </c:otherwise> 
   </c:choose>
