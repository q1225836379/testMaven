...
<div class="button_bar">
	...
	<button class="common_button" onclick="to('../basd/toAdd.action');">新建</button>
	<button class="common_button" onclick="save('dict');;">查询</button>  
</div>
<form action="../basd/list.action" id="dict">
...
<table class="data_list_table"> 
	...
	<tr>
		...
		<c:if test="${basd.dictIsEditable!=0}">
			<img onclick="to('../basd/toEdit.action?dictId=${basd.dictId}');" title="编辑" src="../images/bt_edit.gif" class="op_button" />
			<img onclick="to('../basd/delete.action?dictId=${basd.dictId}');" title="删除" src="../images/bt_del.gif" class="op_button" />
		</c:if>
...
<form action="../basd/list.action" id="go">
<div class="pager">
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../basd/list.action?pageNum=1&dictType=${basd.dictType}&dictItem=${basd.dictItem}&dictValue=${basd.dictValue}&pageSize=${pageInfo.pageSize}">首页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../basd/list.action?pageNum=${pageInfo.pageNum-1}&dictType=${basd.dictType}&dictItem=${basd.dictItem}&dictValue=${basd.dictValue}&pageSize=${pageInfo.pageSize}">上一页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../basd/list.action?pageNum=${pageInfo.pageNum+1}&dictType=${basd.dictType}&dictItem=${basd.dictItem}&dictValue=${basd.dictValue}&pageSize=${pageInfo.pageSize}">下一页</a>
	      </c:otherwise> 
    </c:choose>
	...
	<c:choose> 
	     ...
	     <c:otherwise>  <!--否则 -->    
	       <a href="../basd/list.action?pageNum=${pageInfo.totalPage}&dictType=${basd.dictType}&dictItem=${basd.dictItem}&dictValue=${basd.dictValue}&pageSize=${pageInfo.pageSize}">最后一页</a>
	      </c:otherwise> 
   </c:choose>
