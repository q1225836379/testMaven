...
<div class="button_bar">
	...
	<button class="common_button" onclick="alert('开发失败，已归档。');window.location.href='../plan/result.action?chcId=${salChance.chcId}&chcStatus=4';">终止开发</button>
	<button class="common_button" onclick="back();">返回</button>
	<!-- 跳转到制定计划页面， -->
	<button class="common_button" onclick="to('../plan/toDevPlan.action?chcId=${salChance.chcId}');">制定计划</button>
	<button class="common_button" onclick="alert('用户开发成功，已添加新客户记录。');window.location.href='../plan/result.action?chcId=${salChance.chcId}&chcStatus=3';">开发成功</button>
